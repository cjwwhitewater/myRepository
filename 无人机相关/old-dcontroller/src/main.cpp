...
#include <jetgpio.h>
#include "PSDKInitialization/PSDKInitializer/PSDKInitializer.h"
...
//                set<string> ptzControlInstructions={"V16", "V17", "V18"};
...
//            // Instruction V19 and V20 are processed by the ibox directly.
