...
{
    return UtilFile_GetFileDataByPath(mediaFileHandle->filePath, offset, len,
                                      data, realLen);
}
...
{
    return DjiMediaFile_DestroyTempFilePriv_JPG(
                (T_DjiJPGTempFilePriv*) mediaFileHandle->mediaFileThm.privThm);
}
                                                           ...
                                                           T_DjiJPGTempFilePriv **pTempFilePrivHandle)
{
    ...
    *pTempFilePrivHandle =
            (T_DjiJPGTempFilePriv*)osalHandler->Malloc(sizeof(T_DjiJPGTempFilePriv));
