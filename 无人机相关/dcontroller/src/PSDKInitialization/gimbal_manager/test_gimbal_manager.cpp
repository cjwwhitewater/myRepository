...
static const T_DjiTestGimbalActionList s_rotationActionList[] =
{
        ...
        {.action = DJI_TEST_GIMBAL_ROTATION, .rotation = {
            DJI_GIMBAL_ROTATION_MODE_RELATIVE_ANGLE, 30,  0,   0,  0.2}},
        {.action = DJI_TEST_GIMBAL_ROTATION, .rotation = {
            DJI_GIMBAL_ROTATION_MODE_RELATIVE_ANGLE, -30, 0,   0,  0.2}},
        {.action = DJI_TEST_GIMBAL_ROTATION, .rotation = {
            DJI_GIMBAL_ROTATION_MODE_RELATIVE_ANGLE, -30, 0,   0,  0.2}},
        {.action = DJI_TEST_GIMBAL_ROTATION, .rotation = {
            DJI_GIMBAL_ROTATION_MODE_RELATIVE_ANGLE, 30,  0,   0,  0.2}},
        {.action = DJI_TEST_GIMBAL_ROTATION, .rotation = {
            DJI_GIMBAL_ROTATION_MODE_RELATIVE_ANGLE, 0,   30,  0,  0.2}},
        {.action = DJI_TEST_GIMBAL_ROTATION, .rotation = {
            DJI_GIMBAL_ROTATION_MODE_RELATIVE_ANGLE, 0,   -30, 0,  0.2}},
        {.action = DJI_TEST_GIMBAL_ROTATION, .rotation = {
            DJI_GIMBAL_ROTATION_MODE_RELATIVE_ANGLE, 0,   -30, 0,  0.2}},
        {.action = DJI_TEST_GIMBAL_ROTATION, .rotation = {
            DJI_GIMBAL_ROTATION_MODE_RELATIVE_ANGLE, 0,   30,  0,  0.2}},
        {.action = DJI_TEST_GIMBAL_ROTATION, .rotation = {
            DJI_GIMBAL_ROTATION_MODE_RELATIVE_ANGLE, 0,   0,   4,  0.2}},
        {.action = DJI_TEST_GIMBAL_ROTATION, .rotation = {
            DJI_GIMBAL_ROTATION_MODE_RELATIVE_ANGLE, 0,   0,   -4, 0.2}},
        {.action = DJI_TEST_GIMBAL_RESET},
        {.action = DJI_TEST_GIMBAL_ROTATION, .rotation = {
            DJI_GIMBAL_ROTATION_MODE_ABSOLUTE_ANGLE, 30,  0,   0,  0.2}},
        {.action = DJI_TEST_GIMBAL_ROTATION, .rotation = {
            DJI_GIMBAL_ROTATION_MODE_ABSOLUTE_ANGLE, -90, 0,   0,  0.5}},
        {.action = DJI_TEST_GIMBAL_ROTATION, .rotation = {
            DJI_GIMBAL_ROTATION_MODE_ABSOLUTE_ANGLE, -60, 0,   0,  0.5}},
        {.action = DJI_TEST_GIMBAL_ROTATION, .rotation = {
            DJI_GIMBAL_ROTATION_MODE_ABSOLUTE_ANGLE, -30, 0,   0,  0.5}},
        {.action = DJI_TEST_GIMBAL_RESET},
};
