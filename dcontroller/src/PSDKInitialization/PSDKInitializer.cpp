...
#include "common/upgrade_platform_opt/upgrade_platform_opt_linux.h"
...
#include "common/monitor/sys_monitor.h"
...
#include "application/dji_sdk_app_info.h"
#include "dji_aircraft_info.h"
#include "widget/test_widget.h"
#include "widget/test_widget_speaker.h"
#include "widget_interaction_test/test_widget_interaction.h"
#include "data_transmission/test_data_transmission.h"
#include "application/dji_sdk_config.h"
...
static void *DjiUser_MonitorTask(void *argument)
{
    ...
    while (1) {
        ...
        tidList = (pid_t*) osalHandler->Malloc(threadCount * sizeof(pid_t));
        if (tidList == NULL) {
        ...
        threadAttribute = (T_ThreadAttribute*) osalHandler->Malloc(
                                threadCount * sizeof(T_ThreadAttribute));
