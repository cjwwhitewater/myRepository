                                                    ...
                                                    void *userData)
{
    ...
    if (widgetType == DJI_WIDGET_TYPE_LIST && index == 8) {
        s_mountPosition = (E_DjiMountPosition)(value + 1);
    }

    if (widgetType == DJI_WIDGET_TYPE_LIST && index == 9) {
        s_extensionPortSampleIndex = (E_DjiExtensionPortSampleIndex)value;
    }
    ...
    if (widgetType == DJI_WIDGET_TYPE_LIST && index == 11) {
        s_extensionPortErrcodeIndex = (E_DjiExtensionPortHmsErrorCodeIndex)value;
    }

    if (widgetType == DJI_WIDGET_TYPE_LIST && index == 12) {
        s_extensionPortErrLevelIndex = (E_DjiExtensionPortHmsErrorLevelIndex)value;
    }
